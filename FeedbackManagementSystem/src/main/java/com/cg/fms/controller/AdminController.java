...
public class AdminController {
	...
	public String addAdmin(@ApiParam(value = "Admin info to add", required = true)@Valid @RequestBody Map<String, String> adm) {
    	...
    	try {
			return adminservice.addAdmin(adm.get("adminName"),adm.get("adminUserName"), adm.get("adminPassword"));
		}
	...
	public Admin updateAdmin(@ApiParam(value = "Update admin object", required = true)@Valid @RequestBody Admin admin,  @ApiParam(value = "Admin Id to update admin object", required = true) @PathVariable("id") String adminId) {
	...
	public ResponseEntity <Admin> removeAdmin(@ApiParam(value = "Admin Id from which admin object will delete from database table", required = true) @PathVariable("id") String adminId) {
	...
	public Admin viewAdminById(@ApiParam(value = "Admin id from which admin object will retrieve", required = true) @PathVariable("id") @Positive String adminId) {
