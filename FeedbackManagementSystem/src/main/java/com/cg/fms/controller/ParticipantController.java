...
public class ParticipantController {
	...
	public String addParticipant(@ApiParam(value = "Participant info to add", required = true)@Valid @RequestBody Map<String, String> part) {
    	...
    	try {
			return participantservice.addParticipant(part.get("participantName"),part.get("participantUserName"), part.get("participantPassword"));
		}
	...
	public Participant addParticipant(@ApiParam(value = "participant object stored in database table", required = true)@Valid @RequestBody Participant participant) {
		logger.trace("addParticipant method in participant controller accessed");
	...
	public ResponseEntity <Participant> removeParticipant(@ApiParam(value = "Participant Id to delete participant object from database table")@PathVariable("id") String participantId) {
