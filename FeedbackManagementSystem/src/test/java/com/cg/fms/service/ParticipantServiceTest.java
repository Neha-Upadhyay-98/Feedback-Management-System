...
class ParticipantServiceTest {
    ...
    void shouldSavedParticipantSuccessfully() throws UserNotFoundException {
        ...
        String savedParticipant = participantService.addParticipant(participant.getParticipantName(), participant.getParticipantUserName(), participant.getParticipantPassword());
